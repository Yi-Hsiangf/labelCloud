...
class Controller:
    ...
    def key_press_event(self, a0: QtGui.QKeyEvent):
        ...
        # Remove all bboxes from pcl
        elif a0.key() == QtCore.Qt.Key_T:
            self.save()
            for bbox_id in range(self.bbox_controller.get_no_of_bboxes()):
                self.bbox_controller.delete_bbox(bbox_id)
            ...
            self.pcd_manager.current_id += 99
            self.next_pcd()
